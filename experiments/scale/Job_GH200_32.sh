...
#SBATCH -J scaling_GH200_32
#SBATCH -o scaling_GH200_32.%J.out
#SBATCH -e scaling_GH200_32.%J.err
#SBATCH --time=3:00:00
#SBATCH -A jureap137

N_base_strong=(22000000 13000000 5000000) # larger problem BSV 100/400 GH200
M_ests=(100 200 400)
...
mv ./log/*_GH200_scaling_32.csv ./log/GH200_scaling/
