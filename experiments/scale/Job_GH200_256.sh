...
#SBATCH -J scaling_GH200_256
#SBATCH -o scaling_GH200_256.%J.out
#SBATCH -e scaling_GH200_256.%J.err
#SBATCH --time=3:30:00
#SBATCH -A jureap137
...
mv ./log/*_GH200_scaling_256.csv ./log/GH200_scaling/
